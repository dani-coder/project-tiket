...
<body>
    ...
    <section class="row section-content">
        <div class="section-title">
            <h2 class="font-judul-bayu">Galeri JogjaExotarium</h2>
            <p>Keseruan-keseruan yang ada didalam JogjaExotarium.</p>
        </div>
        <div class="row">
        ...
        <div class="single-portfolio col-md-4">
                <div class="inner">
                    <div class="portfolio-img">
                            <img src="image/gambar/galeri.JPG" alt="portfolio-image" style="width: 300px; height: 200px;">
                            <div class="hover-content">
                                <div>
                                    <a href="image/gambar/galeri.JPG" class="btn btn-info btn-fill z-bottom-0 card-position" target="_blank">Lihat Gambar</a>
                                </div>
                            </div>
                        </div>
                    </div>
