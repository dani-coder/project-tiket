...
<div class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-8">
                    <form action="datadirieditproses.php" method="post" name="form1">
                        <div class="card">
                            <div class="header">
                                <h3 class="text-center"><b>FORM EDIT DATA DIRI</b></h3>
                                 <div class="content">
                                 <div class="card-content">
                                
                                 <?php
                                    $pengujung_id = $_GET["id"];
                                    $result = mysqli_query($konek, "SELECT*FROM tbl_pengunjung where id_pengunjung = '$pengujung_id' ");
                                 ...
                                 ?>
                                     ...
                                     <div class="form-group row">
                                        <div class="col-sm-10">
                                            <div class="col-md-10">
                                                <input type="text" name="id_pengunjung" class="form-control" value="<?php echo $id_pengunjung ?>" readonly>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-10">
                                            <div class="col-md-10">
                                                <label>Nama</label>
                                                <input type="text" name="nama_pengunjung" class="form-control" placeholder="nama lengkap anda" value="<?php echo $nama_pengunjung ?>" >     
                                        </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-10">
                                            <div class="col-md-10">
                                                <label>Email</label>
                                                <input type="email" name="email_pengunjung" class="form-control" placeholder="email anda" value="<?php echo $email_pengunjung ?>" >     
                                        </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-10">
                                            <div class="col-md-10">
                                                ...
                                                <input type="number" name="no_hp_pengunjung" class="form-control" placeholder="+62" value="<?php echo $no_hp_pengunjung ?>" >
                                    ...
                                    <div class="col-sm-10">
                                            <div class="col-md-10">
                                                <label>Alamat</label>
                                                <textarea rows="5" cols="5" class="form-control" name="alamat_pengunjung" value="<?php echo $alamat_pengunjung ?>" ></textarea>   
                                        </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-10">
                                            <div class="col-md-10">
                                            <a class="btn btn-danger btn-fill z-bottom-0 card-position" href="datadiri.php">Kembali</a> 
                                 ...
                                 <div class="form-group row">
                                    <div class="col-sm-20">
                                            <div class="col-md-30">
                                            <a href="pemesanan.php" class="button button1">KEMBALI</a>
                                            <a href="jadwal.php" class="button button2">SELANJUTANYA</a>
                                        </div>
                                        </div>
                                    </div>
