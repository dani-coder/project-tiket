                        ...
                        <div class="card">
                            ...
                            <table class="table table-hover table-striped">
                                   ...
                                   $subtotal = 0;
                                    ...
                                    tbl_bayar.bayar_tgl,
                                    tbl_bayar.bayar_total FROM tbl_pemesanan INNER JOIN tbl_bayar ON 
                                    tbl_pemesanan.id_pemesanan=tbl_bayar.id_pemesanan order by bayar_tgl desc");
                                    }
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="nota.php?id=<?php echo $ambilpengunjung['id_bayar']; ?>" class="btn btn-info btn-sm">
                                                <i class="fa fa-envelope" style="font-size:17px"></i></a>
                                                <a href="pembayaranedit.php?id=<?php echo $ambilpengunjung['id_bayar']; ?>" class="btn btn-warning btn-sm">
                                                <i class="fa fa-edit" style="font-size:17px"></i></a>
                                                <a href="pembayaranhapus.php?id=<?php echo $ambilpengunjung["id_bayar"]; ?>" class="btn btn-danger btn-sm">
