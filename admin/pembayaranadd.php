    ...
    <div class="main-panel">
        ...
        <div class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                    <form action="pembayaranaddproses.php" method="post" enctype="multipart/form-data">
                        <div class="card">
                            <div class="header">
                            ...
                            <div class="form-group row">
                                    <div class="col-sm-10">
                                            <div class="col-md-10">
                                                <input type="text" name="id_bayar" class="form-control" value="<?php echo $kodepengunjung ?>" readonly>
                                        </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-10">
                                            ...
                                            while($row_brg3= mysqli_fetch_array($barang3)) {
                                              ?>
                                              <option value="<?php echo $row_brg3["id_pemesanan"]?>"><?php echo $row_brg3['item_pemesanan']?></option>
		                                          <?php } ?>
                                            </select>
                                                </div>
                                       </div> 
                                    ...
                                    <div class="col-sm-10">
                                            ...
                                            <label>Tanggal Pembayaran</label>
                                                <input type="date" name="bayar_tgl" class="form-control">
                                        </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-10">
                                            <div class="col-md-10">
                                                ...
                                                <input type="number" name="bayar_total" class="form-control" placeholder="12345">
