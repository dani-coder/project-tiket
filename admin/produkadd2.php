    ...
    <div class="main-panel">
        ...
        <div class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                    <form action="produkaddproses2.php" method="post" name="form1">
                        <div class="card">
                            <div class="header">
                            ...
                            <div class="content table-responsive table-full-width">
                                    ...
                                    <div class="col-sm-10">
                                            <div class="col-md-10">
                                                <input type="hidden" name="id_outbond" class="form-control" value="<?php echo $kodeoutbond ?>" readonly>
                                        </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-10">
                                            <div class="col-md-10">
                                                ...
                                                <input type="text" name="outbond_nama" class="form-control" placeholder="nama paket outbond">     
                                        </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-10">
                                            <div class="col-md-10">
                                                <label>Harga</label>
                                                <input type="number" name="outbond_harga" class="form-control" placeholder="Rp.">
