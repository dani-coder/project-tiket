            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">FORM PRODUK OUTBOND </h4>
                                <a href="produkadd2.php">
                            ...
                            <div class="content table-responsive table-full-width">
                                ...
                                <table class="table table-hover table-striped">
                                    ...
                                    <tbody>
                                    <?php
                                $result = mysqli_query($konek, "SELECT*FROM tbl_outbond");
                                ...
                                ?>
                                        <tr>
                                            <td><?php echo $id_outbond; ?></td>
                                            <td><?php echo $outbond_nama; ?></td>
                                            <td><?php echo $outbond_harga; ?></td>
                                            <td>
                                                <div class="form-group row">
                                                <div class="col col-md-2">
                                                <a href="produkedit2.php?id=<?php echo $ambiloutbond['id_outbond']; ?>" class="btn btn-warning btn-sm">
                                                ...
                                                <div class="form-group row">
                                                <div class="col col-md-2">
                                                <a href="produkhapus2.php?id=<?php echo $ambiloutbond['id_outbond']; ?>" class="btn btn-danger btn-sm">
