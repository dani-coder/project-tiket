...
<div class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-8">
                    <form action="pesanpelanggan.php" method="post" name="form1">
                        <div class="card">
                            <div class="header">
                                 <div class="content">
                                 <div class="card-content">
                                      ...
                                      <div class="form-group row">
                                        ...
                                        <h4 class="title"><b>INFORMASI<b></h4>
                                          </header>
                                            <p style="padding-left: 10px;">Jam Operasional:</p>
                                            <p style="padding-left: 10px;">(Selama pandemi Covid-19)</p>
                                               <ul>
                                              <li>Setiap hari</li>
                                              <li>Pukul 09:00 - 16:30 WIB</li>
                                              <li>Jam pelayanan tiket terakhir pukul 16.00 WIB</li>
                                              </ul>
                                              <ul>
                                              <li>Sementara wahana yang sudah bisa dinikmati adalah wahana satwa, wahana perahu bebek, wahana panahan (weekend only), wahana tunggang kuda.</li>
                                              <li>Wahana air (kolam renang, tangkap ikan dan terapi ikan) masih tutup.</li>
                                              </ul>
                                              <p>&nbsp;</p>
                                              <div class="item">
                                              <img class="img img-responsive" alt="" src="image/gambar/layout2.jpg" />
                                              </div>
                                          </div>
                                  <p>SILANGKAN MELENGKAPI FORM PEMESANAN ANDA DENGAN MENEKAN TOMBOL DIBAWAH INI</p
                                 <div class="form-group row">
                                    <div class="col-sm-20">
                                            <div class="col-md-30">
                                            <a href="datadiri.php" class="button button1">ISI DATA DIRI</a>
                                            <a href="produk.php" class="button button1">PILIH PRODUK</a>
                                            <a href="validasi.php" class="button button1">VALIDASI</a>
                                            <a href="upload.php" class="button button1">BAYAR/UPLOAD</a>
                                        </div>
                                        </div>
                                    </div>
